...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).component("stepper-widget", {
  props: {
    steps: Array,
    activeStepIndex: {
      type: Number,
  ...
  methods: {
    nextStep: function nextStep() {
      var nextIndex = this.activeStepIndex + 1;
      this.setActiveStep(nextIndex);
    },
    prevStep: function prevStep() {
      var prevIndex = this.activeStepIndex - 1;
